      ...
      <div>
        <div className={styles.feed_name}>
          ...
          <div className={styles.name_content}>
            ...
            <span className={styles.name_content_txt}> 건설/기계 직군 공개채용</span>
          </div>
          <a className={styles.link_txt}> 지원</a>
        </div>
        <div className={styles.feed_name}>
          ...
          <div className={styles.name_content}>
            ...
            <span className={styles.name_content_txt}> 소주나 마시자</span>
          </div>
          <a className={styles.link_txt}> 지원</a>
        </div>
        <div className={styles.feed_name}>
          ...
          <div className={styles.name_content}>
            ...
            <span className={styles.name_content_txt}> 07시 출근 22시 퇴근 주말 없이</span>
          </div>
          <a className={styles.link_txt}> 지원</a>
        </div>
      </div>
