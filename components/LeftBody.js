...
import { Carousel } from './BootstrapHead';
              ...
              <Carousel>
                {feed.image.map((img) => (
                  <Carousel.Item key={img}>
                    <img className={styles.feed_img} src={img} alt={feed.user_id} />
                  </Carousel.Item>
                ))}
              </Carousel>
...
const feeds = [
  {
    ...
    image: [
      'https://daoift3qrrnil.cloudfront.net/content_images/images/000/127/434/original/%EC%B1%84%EC%9A%A9%EA%B3%B5%EA%B3%A0_r1.png?1658714714',
      'https://ottogi.co.kr/pds/editor/2020-10-19_517133489[2].jpg',
      'https://ottogi.co.kr/pds/editor/2020-10-19_517133489[2].jpg',
      'https://ottogi.co.kr/pds/editor/2020-10-19_517133489[2].jpg'
    ]
  },
  {
    ...
    image: [
      'https://post-phinf.pstatic.net/MjAxOTA2MjRfMTcg/MDAxNTYxMzUzMjkyNjIx.oP-m6lCS0OfZtmZr3EggV6SXr8lZclr0NamrgZx1AIEg.RhB9HljEXJLXfDTBC23pXcEhKDrcSyS0p9GLAEeXWosg.JPEG/IMG_3231.jpg?type=w1200'
    ]
  },
  {
    user_id: 'jane_doe',
    ...
    profile_image: 'https://img.hani.co.kr/imgdb/original/2007/1227/68227042_20071227.jpg',
    image: [
      'https://leadon-brandsite-prd-s3-seoul-img.s3.amazonaws.com/ElandCsr/editor/2022122208233310432139-dde9-498c-922b-ba943b0a3e0c.png'
    ]
  },
  {
    user_id: 'jane_doe',
    ...
    profile_image: 'https://img.hani.co.kr/imgdb/original/2007/1227/68227042_20071227.jpg',
    image: [
      'https://miricanvas.zendesk.com/hc/article_attachments/4408461715737/______1_.png'
    ]
  }
]
